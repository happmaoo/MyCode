        ...
        BroadcastReceiver uiUpdateReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(Objects.equals(uitext, "recording")){
                    ...
                    //button1.setBackgroundColor(Color.parseColor("#f56276"));
                    button1.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#f56276"))); // 设置背景色调为白色

                    bcommand="stop_record";
                }else{
                    button1.setText("Start");
                    button1.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#6cf562")));
