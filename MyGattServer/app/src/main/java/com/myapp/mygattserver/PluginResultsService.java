...
public class PluginResultsService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        // 设置全局变量
        gval.set_termux_result(resultBundle.getString(TERMUX_SERVICE.EXTRA_PLUGIN_RESULT_BUNDLE_STDOUT, ""));
        Log.d("aaaaa","结果:"+resultBundle.getString(TERMUX_SERVICE.EXTRA_PLUGIN_RESULT_BUNDLE_STDOUT, ""));
    }
