...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.putExtra("DEVICE_ADDRESS", "3C:28:6D:DD:D3:0D");
        //intent.putExtra("message","Android 8.0 系统静态广播的测试数据");
        sendBroadcast(intent);

        // 外部调用方法
        //am broadcast -a com.example.gattclient -n com.example.gattclient/com.example.gattclient.MyBroadcastReceiver --es DEVICE_ADDRESS "3C:28:6D:DD:D3:0D" --es SERVICE_UUID 0000aaa0-0000-1000-8000-aabbccddeeff --es CHARACTERISTIC_UUID 0000abc0-0000-1000-8000-aabbccddee00
        ...
        intentui.putExtra("uitext","我是来测 A 应用的Android 8.0 系统静态广播的测试数据");
