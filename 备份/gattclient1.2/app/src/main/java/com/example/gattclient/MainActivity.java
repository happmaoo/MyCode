...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 外部调用方法
        //am broadcast -a com.example.gattclient -n com.example.gattclient/com.example.gattclient.MyBroadcastReceiver --es DEVICE_ADDRESS "3C:28:6D:DD:D3:0D" --es SERVICE_UUID 0000aaa0-0000-1000-8000-aabbccddeeff --es CHARACTERISTIC_UUID 0000abc0-0000-1000-8000-aabbccddee00 --es CHARACTERISTIC_WRITE abc
